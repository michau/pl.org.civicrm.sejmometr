 ...
 */
class CRM_Sejmometr_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Sejmometr_Upgrader(
        'pl.org.civicrm.sejmometr',
        __DIR__ .'/../../../'
      );
    }
   ...
   *
   * @code
   * CRM_Sejmometr_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
